...
mothUnitName<-checkARUname("s2lam065")
...
unzipGooglePath<-checkInputPaths("G:/Shared drives/NASA_S2L_Audio_2020/",type="goog") # Mandatory: the Google destination drive for unzipped files
zipGooglePath<-checkInputPaths("G:/Shared drives/NASA  S2L/Audio Recording Data/RawData/",type="goog") # Mandatory: the Google destination drive for the zipped folder
